...
tellraw @s [{text:"[清扫掉落物]",bold:true,color:green,click_event:{action:"run_command",command:"trigger trigger set 5"},hover_event:{action:"show_text",value:"启动扫地机"}},{"text":"   "},{text:"[粒子菜单]",click_event:{action:"run_command",command:"trigger trigger set 8"},hover_event:{action:"show_text",value:"打开粒子模式设置菜单"},color:green}]
...
tellraw @s [{text:"服务器种子",hover_event:{action:"show_text",value:"点击复制"},click_event:{action:"copy_to_clipboard",value:"1861731603229431126"}}]
tellraw @s {text:"------------------------------------------",color:"red"}
