...
tellraw @s [{text:"[清扫掉落物]",bold:true,color:green,click_event:{action:"run_command",command:"trigger trigger set 5"},hover_event:{action:"show_text",value:"启动扫地机"}},{"text":"   "},{text:"[自杀]",bold:true,"click_event":{action:"run_command",command:"trigger trigger set 6"},"hover_event":{"action":"show_text","value":"自杀"},"color":green}]
