...
execute if score #random tips_random matches 21 run tellraw @s {"text":"2026年6月是第25个全国安全生产月，主题是'人人讲安全，个个会应急——排查整治风险隐患'。安全无小事，防患于未然。让我们在生电生产中，排查机器隐患，守护心态平安。AreoCraft管理组宣",color:aqua}
